    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 pt-6 pb-12">
        ...
        <InfoSection
          ...
          intro="GPA (Grade Point Average), özellikle yurt dışı başvurularında kullanılan 4.0'lık not sistemidir. Türkiye'deki 4'lük GNO doğrudan karşılık gelir; 100'lük sistemden dönüşüm ise tabloya göre yapılır."
